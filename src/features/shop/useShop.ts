...
export const DEMO_ITEMS: RawShopItem[] = [
  ...
  { id: 'p4',  category: 'species',   name: 'Oso polar mágico',    description: 'Peludo y adorable. Genera copos de nieve.',            price_gems: 400,  price_real_cents: null, is_premium_only: false, rarity: 'epic',      asset_url: '🐻', preview_url: '🐻', available_from: null, available_until: null, species_key: 'polar-bear' },
